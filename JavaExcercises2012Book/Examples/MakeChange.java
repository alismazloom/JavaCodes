...
public class MakeChange 
{
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("The number of half dollars " + "to be returned is "
                       + change / HALFDOLLAR);
		change = change % HALFDOLLAR;
		System.out.println("The number of quarters to be " + "returned is "
                       + change / QUARTER);
		change = change % QUARTER;
		System.out.println("The number of dimes to be " + "returned is "
				   	+ change / DIME);
		change = change % DIME;
		System.out.println("The number of nickels to be " + "returned is "
				+ change / NICKEL);
